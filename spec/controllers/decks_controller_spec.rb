...
RSpec.describe DecksController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      deck = Deck.create! valid_attributes
      get :show, params: {id: deck.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Deck" do
        expect {
          post :create, params: {deck: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new deck" do
        ...
        post :create, params: {deck: invalid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested deck" do
        deck = Deck.create! valid_attributes
        put :update, params: {id: deck.to_param, deck: new_attributes}, session: valid_session
        deck.reload
      ...
      it "renders a JSON response with the deck" do
        ...
        put :update, params: {id: deck.to_param, deck: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the deck" do
        ...
        put :update, params: {id: deck.to_param, deck: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested deck" do
      deck = Deck.create! valid_attributes
      expect {
        delete :destroy, params: {id: deck.to_param}, session: valid_session
      }.to change(Deck, :count).by(-1)
    end
  end
